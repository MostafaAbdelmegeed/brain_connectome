...
class Net(torch.nn.Module):
    def __init__(self, functional_groups, num_nodes, hidden_dim, edge_dim, out_dim, atlas=116, dropout=0.5):
        ...
        self.node_conv1 = AlternateConvolution(in_features_v=num_nodes, out_features_v=hidden_dim, in_features_e=edge_dim, out_features_e=edge_dim, node_layer=True)
...
dataset = SimpleConnectivityDataset(data)
...
# TensorBoard writer
writer = SummaryWriter(log_dir=f'runs/{dataset_name}_see_s{seed}')
